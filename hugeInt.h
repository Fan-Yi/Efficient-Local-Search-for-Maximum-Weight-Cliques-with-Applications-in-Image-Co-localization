...
public:
	...
	//friend functions
	//comparison
	friend int operator>=(HugeInt hugeNum1, HugeInt hugeNum2);
	friend int operator<=(HugeInt hugeNum1, HugeInt hugeNum2);
	friend int operator>=(HugeInt hugeNum, int n);
	friend int operator<=(HugeInt hugeNum, int n);
	//manipulation
...
//friend functions
	int operator>=(HugeInt hugeNum1, HugeInt hugeNum2)
	{
